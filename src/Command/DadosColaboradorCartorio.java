...
public class DadosColaboradorCartorio implements Command {
...
*/
  		...
  		usuario = us.carregarLogin(usuario.documentoEmpresa, usuario.tipoCadastro);
		request.setAttribute("usuario", usua);
		view = request.getRequestDispatcher("VisualizarLoginColaboradorCartorio.jsp");		
