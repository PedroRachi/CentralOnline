...
public class AlterarUsuarioCartorioColaborador implements Command {
	...
	public void executar(HttpServletRequest request, HttpServletResponse response)
		...
		if (usuario1.getSenha().equals(pSenha)) {
			...
			RequestDispatcher rd = request.getRequestDispatcher("/VisualizarLoginColaboradorCartorio.jsp");
