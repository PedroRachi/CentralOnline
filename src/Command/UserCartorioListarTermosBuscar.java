...
public class UserCartorioListarTermosBuscar implements Command {
	...
	public void executar(HttpServletRequest request, HttpServletResponse response)
		...
		RequestDispatcher dispatcher = request.getRequestDispatcher("ListarTermosUsuarioCartorio.jsp");
