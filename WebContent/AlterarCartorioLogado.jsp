...
<body>
	...
	<div id="main" class="container">
		...
		<form action="controller.do" method="post">
			...
			<h3 class="page-header">Dados ${cartorio.tipoPerfil} Seu CNPJ
				Cadastrado na Central é ${cartorio.cartorioCNPJ}</h3>
			...
			<div class="row">
				<div class="form-group col-md-2">
					<label for="cep">CEP</label> <input type="text"
						...
						placeholder="00000-000" value="${cartorio.cep}">
				</div>
			...
			<div id="actions" class="row">
				<div class="col-md-12">
					<a href="#" class="btn btn-danger" data-toggle="modal"
						data-target="#delete-modal">Salvar</a> <a href="indexCartorio"
