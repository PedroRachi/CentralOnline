       ...
       <div class="alert alert-success">
		...
		<form action="cadastro.do" method="post" onSubmit="return validarFormulario()">
			...
			<div class="row">
				...
				<div class="form-group col-md-2">
					<label for="id">Cadastro</label> <input type="text" class="form-control"
				...
				<div class="form-group col-md-2">
					<label for="tipoPerfil">Perfil*</label> <input type="text"
						...
						maxlength="14" placeholder="CNPJ" value="${cartorio.tipoPerfil}" readonly="true">
				</div>
			</div>
			...
			<!--<div class="row">
				<div class="form-group col-md-4">
					<label for="dataHoraFuncionamento">Horario de Funcionamento</label> <input type="text"
						class="form-control" name="dataHoraFuncionamento" id="dataHoraFuncionamento" required maxlength="50"
						placeholder="horario funcionamento">
				</div>-->
				
				<div class="row">
				<div class="form-group col-md-2">
					<label for="#">Telefone</label> <input type="text"
						class="form-control" name="telCartorio" id="telCartorio" required maxlength="15"
			...
			<div class="row">
				<div class="form-group col-md-6">
					...
					<textarea class="form-control" rows="3" name="dataHoraFuncionamento" id="dataHoraFuncionamento" required
						maxlength="200" placeholder="Maximo de 200 caracteres"></textarea>
				</div>
			</div>
			...
			<div class="row">
				<div class="form-group col-md-2">
					<label for="cep">CEP</label> <input type="text" class="form-control"
						name="cep" id="cep" required maxlength="9" placeholder="00000-000"
						>
				</div>
			</div>
			...
			<div class="row">
				<div class="form-group col-md-6">
					<label for="logradouro">Logradouro</label> <input type="text"
						class="form-control" name="logradouro" id="logradouro" required maxlength="50"
			...
			<div class="row">
				<div class="form-group col-md-4">
					<label for="cidade">Cidade</label> <input type="text"
						class="form-control" name="cidade" id="cidade" required maxlength="20"
						placeholder="informe a Cidade">
				</div>
				<div class="form-group col-md-2">
					<label for="estado">Estado</label> <input type="text"
						class="form-control" name="estado" id="estado" required maxlength="2"
						placeholder="UF">
				</div>
			...
			<input type="checkbox" name="termo" value="male" id="termo"> Li e
			...
			<div id="actions" class="row">
				...
				<div class="col-md-12">
					...
					<button onclick="redirecionar();" type="submit"
						class="btn btn-primary" name="command" value="CartorioAposPreCadastro">Salvar</button>
