...
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
        ...
        <body>
            ...
            <div id="main" class="container">
                ...
                <button class="btn btn-primary" type="submit" name="command" value="ListarUsuarioEmpresaBuscar">
                                       ...
                                       <tr>
                                            ...
                                            <td class="actions">
                                                ...
                                                <a class="btn btn-warning btn-xs" href="controller.do?command=EditarUsuarioAdicional&id=${usuario.id}">Editar</a>
                                                  <a class="btn btn-default btn-xs"  href="controller.do?command=AlterarSituacaoUsuarioEmpresa&id=${usuario.id}">Bloquear</a>
                                                
                                                 <a class="btn btn-primary btn-xs"  href="controller.do?command=AtivarSituacaoUsuarioEmpresa&id=${usuario.id}">Ativar</a>
