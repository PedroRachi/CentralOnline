...
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
        ...
        <body>
            ...
            <div id="main" class="container">
                ...
                <button class="btn btn-primary" type="submit" name="command" value="ListarUsuarioBuscar">
          					...
          					<c:forEach var="usuario" items="${lista}">
                                       <tr>
                                            ...
                                            <td class="actions">
                                                ...
                                                <a class="btn btn-default btn-xs"  href="controller.do?command=AlterarSituacaoUsuario&id=${usuario.id}">Bloquear</a>
                                                
                                                 <a class="btn btn-primary btn-xs"  href="controller.do?command=AtivarSituacaoUsuario&id=${usuario.id}">Ativar</a>
